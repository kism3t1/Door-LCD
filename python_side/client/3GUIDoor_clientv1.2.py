...
class gui(tkinter.Tk):
        ...
        def OutButtonClick(self):
                ...
                Label.grid(column=1, row=0)
        def InButton(self):
                f = open('doorlog.dat','a')
                f.write("Displaying ICT support department\n")
                f.close
        ...
        def meetingButton(self):
                f = open('doorlog.dat','a')
                f.write("Sorry in a meeting is being displayed\n")
                f.close
        ...
        def FaceButtonClick(self):
                f = open('doorlog.dat','a')
                f.write("Displaying a face on the LCD!\n")
                f.close
        ...
        def ExitButton(self):
                f = open('doorlog.dat','a')
                f.write("Closing server and client\n")
                f.close
